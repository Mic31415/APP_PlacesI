...
import { View, StyleSheet, Platform, useWindowDimensions, DeviceEventEmitter } from 'react-native';
...
export const BannerAdView: React.FC<BannerAdProps> = ({ size = BannerAdSize.BANNER }) => {
    ...
    useEffect(() => {
        ...
        const listener = DeviceEventEmitter.addListener('adsConsentReady', (isAllowed) => {
